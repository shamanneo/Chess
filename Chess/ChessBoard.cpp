...
CChessBoard::CChessBoard(HWND hwnd, bool is_white)
{
    Clear() ; 
    if(is_white)
    {
    ...
    else 
    {
        ...
        m_chess_board[3][7] = new CBQueen(3, 7, this, hwnd) ;
        m_chess_board[4][7] = new CBKing(4, 7, this, hwnd) ;
        m_chess_board[5][7] = new CBBishop(5, 7, this, hwnd) ;
